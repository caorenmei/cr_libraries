...
set(_CR_CPP_NETLIB_SRC "${_CR_PROJECT_ROOT}/third_party/cpp-netlib/cpp-netlib-0.13.0")
...
function(_build_cpp_netlib buildMode)
    ...
    execute_process(
        COMMAND cmake -G "${_CR_MAKEFILE}" -DCPP-NETLIB_BUILD_TESTS=OFF -DCPP-NETLIB_BUILD_EXAMPLES=OFF
        -DCPP-NETLIB_ENABLE_HTTPS=OFF -DCPP-NETLIB_STATIC_BOOST=ON -Dcppnetlib_MSVC_STATIC_RUNTIME=ON
        -DBoost_USE_STATIC_RUNTIME=ON -DUri_BUILD_TESTS=OFF -DUri_BUILD_DOCS=OFF -DUri_WARNINGS_AS_ERRORS=OFF
        -DCMAKE_BUILD_TYPE=${buildMode} -DCMAKE_INSTALL_PREFIX=${_CR_CPP_NETLIB_INSTALL_DIR} 
        -B "${_CR_CPP_NETLIB_BUILD_DIR}" "${_CR_CPP_NETLIB_SRC}" WORKING_DIRECTORY "${_CR_CPP_NETLIB_BUILD_DIR}"
    )
    # 编译 & 安装
