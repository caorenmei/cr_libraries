...
function(_build_mysql buildMode)
    ...
    execute_process(
        COMMAND cmake -G "${_CR_MAKEFILE}" ${_CR_EXE_LINKER_FLAGS} -DDISABLE_SHARED=TRUE -DWITHOUT_SERVER=TRUE -DENABLED_PROFILING=OFF -DCMAKE_BUILD_TYPE=${buildMode} -DCMAKE_INSTALL_PREFIX=${_CR_MYSQL_INSTALL_DIR} -B "${_CR_MYSQL_BUILD_DIR}" "${_CR_MYSQL_SRC}"
